<html lang="vi">
  <head>
    ...
    <style>
      ...
      /* Đảm bảo tên và giá nằm trên các dòng khác nhau */
      .product-info .name {
        font-size: 1.3em;
        color: #0044cc;
      }
      ...
      /* Nút đặt và lưu thông tin nằm trên cùng một hàng */
      .product-actions {
        display: flex;
        gap: 10px;
        margin-top: 10px;
    ...
    <div class="container">
      ...
      <div class="product-row">
        ...
        <div class="product-right">
          <p>
            Thông tin chi tiết về sản phẩm 1 sẽ được cung cấp ở đây. Bạn có thể
            mô tả thêm về đặc điểm, công dụng, hoặc hướng dẫn sử dụng của sản
            phẩm này.
          </p>
        </div>
      </div>
      ...
      <div class="product-row">
        ...
        <div class="product-right">
          <p>
            Thông tin chi tiết về sản phẩm 2 sẽ được cung cấp ở đây. Bạn có thể
            mô tả thêm về đặc điểm, công dụng, hoặc hướng dẫn sử dụng của sản
            phẩm này.
          </p>
        </div>
